...
class _NoticeBoardState extends State<NoticeBoard> {
  ...
  // ── Post new notice dialog ──
  void _showPostDialog() {
    final titleCtrl   = TextEditingController();
    final messageCtrl = TextEditingController();
    String selectedCategory = "General";
    String selectedTarget   = "All Students";
    bool isPosting = false;

    final targets = [
      "All Students", "MCA", "BCA", "MCA - A", "MCA - B",
      "MCA - C", "BCA - A", "BCA - B", "BCA - C",
    ];
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            ...
                            items: targets
                                ...
                                .toList(),
                            onChanged: (v) =>
                                setModalState(() => selectedTarget = v!),
                          ),
                        ),
                      ),
  ...
  Map<String, dynamic>? _catFor(String label) {
    try {
      return _categories.firstWhere((c) => c["label"] == label);
    } catch (_) {
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  ..._categories.map((cat) => _filterTab(
                    cat["label"] as String,
                    cat["icon"] as IconData,
                    cat["color"] as int,
                  )),
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                // Sort client-side by postedAt descending
