...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  List<String> get absentIds =>
      attendance.entries.where((e) => !e.value).map((e) => e.key).toList();

  bool get allPresent =>
      attendance.isNotEmpty && attendance.values.every((v) => v);
  bool get allAbsent =>
      attendance.isNotEmpty && attendance.values.every((v) => !v);

  void _markAllPresent() =>
      setState(() { for (final k in attendance.keys) attendance[k] = true; });
  void _markAllAbsent() =>
      setState(() { for (final k in attendance.keys) attendance[k] = false; });
  ...
  Future<void> checkIfAlreadyTaken() async {
    try {
      ...
      final startOfDay =
      DateTime(checkDate.year, checkDate.month, checkDate.day, 0, 0, 0);
      final endOfDay =
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
                  ...
                  child: Row(children: [
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          Text(
                              "${widget.subject}  ·  "
                                  "${widget.lectureType} L${widget.lectureNo}",
                              style: TextStyle(
              ...
              Row(children: [
                _countCard("Total", totalStudents,
                    Icons.groups_rounded, const Color(0xFF1E3A5F)),
                const SizedBox(width: 10),
                _countCard("Present", presentCount,
                    Icons.check_circle_rounded, Colors.green),
                const SizedBox(width: 10),
                _countCard("Absent", absentCount,
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            sortedIds.isEmpty
                ...
                : Column(
              children: List.generate(sortedIds.length, (i) {
                ...
                return Container(
                  ...
                  child: Row(children: [
                    ...
                    const SizedBox(width: 10),
                    Expanded(
                      child: Text(roll.isNotEmpty ? roll : name,
                          style: const TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: isChecking
        ...
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min,
              children: [
                ...
                const SizedBox(height: 12),
                Text(
                    "${widget.subject} (${widget.lectureType})\n"
        ...
        // ✅ Students list — filtered by collegeId only
        // (semester aur status filter NAHI — students mein
        //  ye fields nahi hote)
        Expanded(
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              final sorted = snapshot.data!.docs.toList()
                ..sort((a, b) {
                  final ar = (a.data() as Map)["rollNumber"]
                  as String? ??
                      "";
                  final br = (b.data() as Map)["rollNumber"]
                  as String? ??
                      "";
