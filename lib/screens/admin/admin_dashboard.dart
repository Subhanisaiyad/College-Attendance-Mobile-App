...
class AdminDashboard extends StatelessWidget {
  final String collegeId; // ✅ collegeId

  const AdminDashboard({super.key, required this.collegeId});
        ...
        child: Column(
          ...
          children: [
            ...
            Text(title,
                ...
                style: TextStyle(
                    fontWeight: FontWeight.w600, fontSize: titleSz)),
