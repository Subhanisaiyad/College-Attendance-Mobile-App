...
import 'package:cloud_firestore/cloud_firestore.dart'; // includes Timestamp
...
class _StudentDashboardState extends State<StudentDashboard> {
  ...
  Future<void> _loadStats() async {
    try {
      ...
      for (var doc in snap.docs) {
        ...
        if (status == "present") {
          bySubject[subject]!["p"] = bySubject[subject]!["p"]! + 1;
        }
      }

      int totalP = 0, totalT = 0;
      for (var s in bySubject.values) {
        totalP += s["p"]!;
        totalT += s["t"]!;
      }
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              // Course - Division
              Text(
                "${widget.course}  ·  Div ${widget.division}",
                style: TextStyle(
              ...
              _drawerItem(context, Icons.bar_chart_rounded, "My Attendance", () {
                Navigator.pop(context);
                Navigator.push(context, MaterialPageRoute(
                    builder: (_) => StudentAttendanceView(
                        studentId: widget.studentId)));
              }),
              _drawerItem(context, Icons.score_rounded, "My Marks", () {
                Navigator.pop(context);
                Navigator.push(context, MaterialPageRoute(
                    builder: (_) => StudentMarksView(
                        studentId: widget.studentId)));
              }),
              _drawerItem(context, Icons.campaign_rounded, "Notice Board", () {
                Navigator.pop(context);
                Navigator.push(context, MaterialPageRoute(
              ...
              _drawerItem(context, Icons.calendar_month_rounded, "My Timetable", () {
                Navigator.pop(context);
                Navigator.push(context, MaterialPageRoute(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // ── Today's Lectures + Attendance combined ──
            _sectionHeader("Today's Lectures", Icons.fact_check_rounded),
            _todayLecturesWithAttendance(),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Your overall attendance is ${_overallAttendance.toStringAsFixed(1)}%. Minimum 75% required.",
                              style: TextStyle(
                                  fontSize: 12,
  ...
  // ── Today's lectures + attendance status combined ──

  // ── Today's lectures — Premium Timeline UI ──

  Widget _todayLecturesWithAttendance() {
              ...
              child: Column(children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      _summaryPill("${lectures.length}", "Total",
                          Colors.white.withValues(alpha: 0.9)),
                      _vDivider(),
                      _summaryPill("$presentCount", "Present", const Color(0xFF4ADE80)),
                      _vDivider(),
                      _summaryPill("$absentCount",  "Absent",  const Color(0xFFFF6B6B)),
                      _vDivider(),
                      _summaryPill("$pendingCount", "Pending", const Color(0xFFFFB347)),
                    ],
                  ),
                ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Wrap(spacing: 8, children: [
                                    _infoTag(Icons.access_time_rounded, "$startTime – $endTime"),
                                    _infoTag(Icons.meeting_room_outlined, room),
                                  ]),
                                ],
                              ),
                            ),
    ...
    return Container(
      ...
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(label, style: const TextStyle(
            fontSize: 10, color: Color(0xFF1E3A5F), fontWeight: FontWeight.w600)),
      ]),
    );
  }
